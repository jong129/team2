...
public class ChatMessageService {
    ...
    /**
     * ✅ ASSISTANT 메시지 저장 + 추천질문 3개까지 함께 저장
    ...
    /**
     * ✅ ASSISTANT 메시지 저장 + 추천질문 + model/tokens 저장
     */
    public ChatMessage saveAssistantMessageWithFollowUpsAndUsage(
        Long memberId,
        Long sessionId,
        String content,
        ...
        log.info(
            ...
            memberId, sessionId, saved.getChatId(), saved.getRole(),
            saved.getModel(), saved.getTokensIn(), saved.getTokensOut(),
            saved.getTokensTotal(), saved.getLatencyMs()
        );
    ...
    /**
     * ✅ 이미 저장된 메시지(chatId)에 추천질문만 업데이트
     */
