...
import dev.jpa.team2.checklist.service.PostChecklistSummaryService;
...
public class PostChecklistSummaryController {
    ...
    private final PostChecklistSummaryService summaryService;
    ...
    public ResponseEntity<PostChecklistSummaryDto> getSummary(
