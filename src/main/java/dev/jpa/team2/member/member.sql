...
COMMENT ON COLUMN MEMBER.PROFILE_IMAGE          IS '프로필 사진';
...
-- INSERT문
INSERT INTO MEMBER (MEMBER_ID,LOGIN_ID,EMAIL,PASSWORD,NAME,PHONE,PROFILE_IMAGE,CREATED_AT) 
VALUES (SEQ_MEMBER_ID.nextval,'admin1','admin1@email.com','1234','ADMIN1','010-1111-2222',NULL,sysdate);

INSERT INTO MEMBER (MEMBER_ID,LOGIN_ID,EMAIL,PASSWORD,NAME,PHONE,PROFILE_IMAGE,CREATED_AT) 
VALUES (SEQ_MEMBER_ID.nextval,'admin2','admin2@email.com','1234','ADMIN2','010-1111-2222',NULL,sysdate);

INSERT INTO MEMBER (MEMBER_ID,LOGIN_ID,EMAIL,PASSWORD,NAME,PHONE,PROFILE_IMAGE,CREATED_AT) 
VALUES (SEQ_MEMBER_ID.nextval,'user1','user1@email.com','1234','홍길동','010-1111-2222',NULL,sysdate);
